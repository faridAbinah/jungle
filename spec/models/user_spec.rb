  ...
  describe 'Validations' do
    context 'password and password_confirmation' do
      it 'should return true if both fields are equal' do
        @user = User.new({first_name:'Farid', last_name: 'Abinah', email:'email@gmail.com', password:'password', password_confirmation: 'password'})
        expect(@user.save).to be true
      end

      it 'should return false if both field are not equal' do
        @user = User.new({first_name:'Farid', last_name: 'Abinah', email:'email@gmail.com', password:'passwordone', password_confirmation: 'passwordtwo'})
        expect(@user.save).to be false
      end

      it 'should return false when either password is not present' do
        @user = User.new({first_name:'Farid', last_name: 'Abinah', email:'email@gmail.com', password_confirmation: 'passwordtwo'})
        expect(@user.save).to be false
      end

      it 'should have minimum length of 4' do
        @user = User.new({first_name:'Farid', last_name: 'Abinah', email:'email@gmail.com', password:'aaa', password_confirmation: 'aaa'})
        expect(@user.save).to be false
      end
    end
    ...
    context 'first_name, last_name and email must be present' do
      it 'should return false if email field is not present' do
        @user = User.new({first_name:'Farid', last_name: 'Abinah', password:'passwordone', password_confirmation: 'passwordtwo'})
        expect(@user.save).to be false
      end

      it 'should return false if first_name is not present' do
        @user = User.new({last_name: 'Abinah', email:'email@gmail.com', password:'passwordone', password_confirmation: 'passwordtwo'})
        expect(@user.save).to be false
      end

      it 'should return false if last name is not present' do
        @user = User.new({first_name:'Farid', email:'email@gmail.com', password:'passwordone', password_confirmation: 'passwordtwo'})
        expect(@user.save).to be false
      end
    end
    ...
    context 'email must be unique and not case sensitive' do
      ...
      it 'should return false if email is not case sensitive' do
        ...
        @user2 = User.new({first_name:'Farid', last_name: 'Abinah', email:'email@gmail.com', password:'password', password_confirmation: 'password'})
        expect(@user2.save).to be false
      end
    end
  end
